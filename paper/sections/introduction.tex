...
\subcaptionbox{$F_1$: After evidence update ($a_4$ rejected)\label{fig:af-f1}}[0.33\textwidth]{%
\begin{tikzpicture}
  \node[acc node] (a1) at (0, 2.0) {$a_1$};
  \node[acc node] (a2) at (1.2, 2.0) {$a_2$};
  \node[new node] (a5) at (1.9, 2.7) {$a_5$};
...
\subcaptionbox{$F_2$: After repair ($a_4$ restored)\label{fig:af-f2}}[0.33\textwidth]{%
\begin{tikzpicture}
  \node[acc node] (a1) at (0, 2.0) {$a_1$};
  \node[acc node] (a2) at (1.2, 2.0) {$a_2$};
  \node[rej node] (a5) at (1.9, 2.7) {$a_5$};
  \node[new node] (a6) at (2.7, 2.7) {$a_6$};
  \node[acc node] (a3) at (0, 1.0) {$a_3$};
  \node[acc node, tgt node] (a4) at (1.2, 1.0) {$a_4$};
  \node[rej node] (a0) at (0.6, 0) {$a_0$};
  \draw[att edge] (a3) -- (a0);
