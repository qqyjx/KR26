...
\begin{tikzpicture}[node distance=0.8cm and 0.8cm,
  ...
  \node[rej node] (a5) at (3.2, -0.85) {$b_5$};
  \node[new node] (a6) at (4.3, -0.85) {$b_6$};
  \draw[att edge] (a5) -- (a3);
  \draw[att edge] (a5) -- (at);
  \draw[att edge, NewBlue!80!black, line width=1.1pt] (a6) -- (a5);
  \node[font=\scriptsize, text=AccGreen!70!black] at (3.2, -1.3) {cost = 2};
\end{tikzpicture}
