...
Since the LLM-generated frameworks in our experiments average 6.8 arguments, both semantics are well within practical time budgets.
...
Grounded-only semantics yields modest decreases across all metrics; the gap is small because 97\% of frameworks in our experiments have a single preferred extension coinciding with the grounded one.
