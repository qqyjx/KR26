...
The cost function $\kappa$ encodes domain-specific preferences (e.g., deletions costlier than additions), connecting to enforcement in abstract argumentation~\cite{baumann2010complexity,cayrol2020argumentation} while adding an explicit cost model for explanation maintenance.
