...
The target argument $a_t$ is \emph{credulously accepted} if it belongs to at least one $\sigma$-extension of $G$, \emph{rejected} if it belongs to none, and \emph{undecided} otherwise. For grounded semantics, which yields a unique extension, credulous and skeptical acceptance coincide.
