...
First, a $k$-neighborhood restriction limits the search space to arguments within distance~$k$ of the target in the attack graph; in our experiments, setting $k{=}3$ sufficed to find optimal repairs in the vast majority of cases while substantially reducing solver grounding.
