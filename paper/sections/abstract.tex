...
A $k$-neighborhood approximation and answer set programming encoding ensure scalability to practical framework sizes.
We validate the framework on HotpotQA and FEVER, where \textsc{Argus} improves faithfulness by \improveFaithfulness{} and contestability by \improveContestability{} w.r.t.\ the strongest argumentation baseline while requiring fewer repair operations than all competing methods.
\end{abstract}
