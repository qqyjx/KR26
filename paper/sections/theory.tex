...
\emph{Consistency} holds by construction: the output of the ASP solver is always a well-formed argumentation framework.
...
For stable semantics, verifying whether a repair ensures credulous acceptance requires checking stable extension existence, which is itself NP-complete~\cite{dvorak2012computational}; the additional repair-guessing layer yields $\Sigma_2^P$-completeness.
