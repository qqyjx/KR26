...
The complexity of the repair problem depends critically on the choice of argumentation semantics. Our results assume credulous acceptance (as defined in \S\ref{sec:preliminaries}), inheriting the corresponding complexity landscape~\cite{dunne2009complexity,dvorak2018computational}.
